...
<BODY>
<FORM id="form1" name="form1" action="adminLogin.do" method="post" onSubmit="return checkForm()">
...
<SCRIPT src="back/back/login_files/WebResource.axd" type=text/javascript></SCRIPT>

<SCRIPT src="back/login_files/WebResource(1).axd" type=text/javascript></SCRIPT>

<SCRIPT src="back/login_files/ScriptResource.axd" type=text/javascript></SCRIPT>

<SCRIPT src="back/login_files/ScriptResource(1).axd" type=text/javascript></SCRIPT>
...
<TABLE cellSpacing=0 cellPadding=0 width=900 align=center border=0>
  <TBODY>
  <TR>                                                           <!-- w -->
    <TD style="HEIGHT: 105px"><IMG src="back/login_files/website_logo.gif"
  border=0></TD></TR>
  <TR>
    <TD background="back/login_files/login_2.jpg" height=300>
  ...
  <TR>
    <TD><IMG src="back/login_files/login_3.jpg" border=0></TD></TR></TBODY></TABLE></DIV></DIV>
</FORM>
