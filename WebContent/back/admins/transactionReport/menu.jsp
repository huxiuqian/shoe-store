...
<table width="200" border="0" cellspacing="0" cellpadding="0" style="margin-bottom:5px;">
  <tr>
    <td style="background: url('back/images/menu_title.gif');"  height="40px"> 
    	<div style="font-size:12px; font-weight:bold; color:#FFF; margin-left:30px;"></div>
    </td>
  </tr>
  <tr>
    <td style="background: url('back/images/menu_blank.gif');"  height="35px">
    	<div style="font-size:12px; margin-left:30px;"><a>业绩报表生成</a></div>
    </td>
  </tr>
  <tr>
    <td style="background: url('back/images/menu_blank.gif');" height="35px">
    	<div style="font-size:12px; margin-left:30px;"><a>营销报表生成</a></div>
    </td>
  </tr>
  <tr>
    <td style="background: url('back/images/menu_blank.gif');" height="35px">
    	<div style="font-size:12px; margin-left:30px;"><a>流量报表生成</a></div>
    </td>
  </tr>
