...
function checkForm1(num){
  ...
  <body>
    <form id="form2" method="post" name="form1" action="BatchDeleteTypes.action" onSubmit="return checkForm1('a');">
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="0" align="center">
      ...
      <tr>
        ...
        <td width="40%" background="back/images/b_table_header.gif" height="34px" align="center" valign="middle"><strong>类型编号</strong></td>
        <td width="40%" background="back/images/b_table_header.gif" height="34px" align="center" valign="middle"><strong>类型名称</strong></td>
      ...
      <tr height="30px" bgcolor="#F7F7F7" 
        ...
        <td align="center" valign="middle"><label>
          <input type="checkbox" name="chk_aid" id="chk_aid" value="${type.tid }"/>
        </label></td>
        <td align="center" valign="middle">${type.tid }</td>
        <td align="center" valign="middle">${type.tname}</td>
        <td align="center" valign="middle"><a href="TypesUpdate.do?tid=${type.tid }">更改</a>&nbsp;&nbsp;
         
          <a href="javascript:if(confirm('确定禁用此类型吗?')){location='DeleteTypes.action?tid=1';}">禁用</a>  
        		</td>
      </tr>
      </c:forEach>
      <!--------------------------分页显示部分---------------------------------->
