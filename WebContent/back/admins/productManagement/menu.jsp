...
<table width="200" border="0" cellspacing="0" cellpadding="0" style="margin-bottom:5px;">
  ...
  <tr>
    <td style="background: url('back/images/menu_blank.gif');" height="35px">
    	<div style="font-size:12px; margin-left:30px;"><a href="showShoes.do" target="productManagement">商品管理-商品列表</a></div>
    </td>
  </tr>
  <tr>
    <td style="background: url('back/images/menu_blank.gif');" height="35px"><!-- AddShoe.jsp -->
    	<div style="font-size:12px; margin-left:30px;"><a href="back/admins/productManagement/AddShoes.jsp" target="productManagement">商品管理-新增商品</a></div>
    </td>
  </tr>
  <tr>
...
<table width="200" border="0" cellspacing="0" cellpadding="0" style="margin-bottom:5px;">
  ...
  <tr>
    <td style="background: url('back/images/menu_blank.gif');" height="35px">
    	<div style="font-size:12px; margin-left:30px;"><a href="brand.do" target="productManagement">品牌管理-品牌列表</a></div>
    </td>
  </tr>
  <tr>
    <td style="background: url('back/images/menu_blank.gif');" height="35px">
    	<div style="font-size:12px; margin-left:30px;"><a href="back/admins/productManagement/AddBrand.jsp" target="productManagement">品牌管理-新增品牌</a></div>
    </td>
  </tr>
  <tr>
    <td style="background: url('back/images/menu_bottom.gif');" height="13px"></td>
...
<table width="200" border="0" cellspacing="0" cellpadding="0" style="margin-bottom:5px;">
  ...
  <tr>
    <td style="background: url('back/images/menu_blank.gif');" height="35px">
    	<div style="font-size:12px; margin-left:30px;"><a href="type.do" target="productManagement">类型管理-类型列表</a></div>
    </td>
  </tr>
  <tr>
    <td style="background: url('back/images/menu_blank.gif');" height="35px">
    	<div style="font-size:12px; margin-left:30px;"><a href="back/admins/productManagement/AddType.jsp" target="productManagement">类型管理-新增类型</a></div>
    </td>
  </tr>
  ...
  <tr>
    <td style="background: url('back/images/menu_blank.gif');" height="35px">
    	<div style="font-size:12px; margin-left:30px;"><a href="showSpcifyShoes.do" target="productManagement">定制鞋查询修改</a></div>
    </td>
  </tr>
  <tr>
