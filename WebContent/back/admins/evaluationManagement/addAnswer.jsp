...
-->
	...
	<body>
		<form method="post" name="form1" action="UpdateResponse.do" onSubmit="return checkForm()">
						...
						<table width="100%" border="0" cellspacing="1" cellpadding="0"	align="center">
							...
							<tr>
								<td colspan="5">
									...
									<input type="hidden" id="sqid" name="sqid"	value="${sqa.sqid }" />
									<table width="80%" border="0" align="center" cellpadding="0"	cellspacing="1">
										...
										<tr>
											...
											<td width="75%" height="35"	background="back/images/b_table_header.gif">
												<input type="text" name="sqanswer" id="sqanswer"/>
											</td>
										</tr>										
										<tr>
