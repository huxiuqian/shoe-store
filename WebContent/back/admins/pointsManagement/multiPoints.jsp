...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="943" height="30" valign="middle" background="back/images/table_bg001.gif"> &nbsp;&nbsp; <img src="back/images/b_sing.gif" width="12" height="12" align="middle" />&nbsp;<font color="#999999">&nbsp;&nbsp; 提示信息及功能说明:设置每日积分倍数</font></td>
  </tr>
   <!----------------------表格标题部分------------------------------>
  <tr>
      ...
      <tr>
      	<td colspan="5">
        	...
        	<table width="60%" border="0" align="center" cellpadding="0" cellspacing="1" >
                ...
                <tr>
                	<td width="43%" height="35" align="right" background="back/images/b_table_header.gif">今日积分倍数：</td>
