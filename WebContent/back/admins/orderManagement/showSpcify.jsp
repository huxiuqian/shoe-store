  ...
  <tr>
   ...
   <tr>
    ...
    <tr>
      ...
      <!----------------------动态数据显示部分------------------------------>
       <c:forEach items="${page.data }" var="spcify">
	      <tr height="30px" bgcolor="#F7F7F7" 
	        ...
	        <td height="35" align="center" valign="middle">${spcify.sprid }</td>
	        <td align="center" valign="middle">${spcify.spsname }</td>
	        <td align="center" valign="middle">${spcify.onum }</td>
	        <td align="center" valign="middle">${spcify.sprscheme }</td>
	        <td align="center" valign="middle">${spcify.sprnum }</td>
	        <td align="center" valign="middle">
	        <c:if test="${order.ostate==1 }">发货途中</c:if>
        	<c:if test="${order.ostate==7 }">发货途中</c:if>
        	<c:if test="${order.ostate==5 }">已退货</c:if>
	        		<a href="javascript:{location='FindSpcifyResultsInfo.do?sprid=${spcify.sprid }';}">定制详情</a>   		
	        </td>
	      </tr>     
      </c:forEach>
