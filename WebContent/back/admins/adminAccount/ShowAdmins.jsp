...
function checkForm(){
  ...
  <body>
    ...
    <form method="post" name="form1" action="AdminSelectPage.do" onsubmit="return checkForm();">
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="0" align="center">
      ...
      <c:forEach items="${page.data }" var="admin">
        ...
        <td align="center" valign="middle"><label>
          <input type="checkbox" name="chk_aid" id="chk_aid" value="1"/>
        </label></td>
        <td height="35" align="center" valign="middle">${admin.aid }</td>
        <td align="center" valign="middle">${admin.acount }</td>
        <td align="center" valign="middle">${admin.apwd }</td>
        <td align="center" valign="middle"><a href="showUpdateAdmin.do?aid=${admin.aid }">更改</a>&nbsp;&nbsp; 
        		<a href="javascript:if(confirm('确定删除该条记录吗？')==true){location='/back/admin!DeleteAdmins.action?aid=1';}">删除</a></td>
      </tr>
      </c:forEach>
