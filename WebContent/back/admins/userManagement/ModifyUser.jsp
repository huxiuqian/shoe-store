...
.STYLE1 {font-size: 16px}
  ...
  <body>
    <form id="form1" method="post" name="form1" action="UserUpdate.do" onSubmit="return checkForm()">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
                ...
                <td width="43%" height="35" align="right" background="back/images/b_table_header.gif">用户性别：</td>
               	  <td width="57%" height="35" background="back/images/b_table_header.gif">
               	      <input type="text" id="ugender" name="ugender" value="${user.ugender }"/>
					</td>
                </tr>
                ...
                <td width="43%" height="35" align="right" background="back/images/b_table_header.gif">用户提示问题：</td>
               	  <td width="57%" height="35" background="back/images/b_table_header.gif"><input type="text" id="upwdask" name="upwdask" value="????"/></td>
                </tr>
                <td width="43%" height="35" align="right" background="back/images/b_table_header.gif">用户提示答案：</td>
               	  <td width="57%" height="35" background="back/images/b_table_header.gif"><input type="text" id="upwdans" name="upwdans" value="??"/></td>
                </tr> -->
                <tr>
