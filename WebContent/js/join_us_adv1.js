...
function showFullScreenAdv(A) {
    ...
    this.run = function() {
        jQuery("#" + this.divId + "").html("<a class='fade_btn' ></a><div class='fade_border'></div><div class='fade_main'><img class='fade_closed' src='images/join_us/dk_ad_closed.gif' height='19' width='19'/>");
        ...
        jQuery("#" + this.divId + " .fade_btn").css({
            ...
            "line-height": "19px",
            "text-align": "center",
            background: "url(images/join_us/bn_play.gif)"
        });
        jQuery("#" + this.divId + " .fade_border").css({
            display: "none",
            left: "995px",
...
var adv_add= [{
        ...
        advParam: "ad_bbs_0804hunbo_980*400",
        advUrl:advertise_add_url,
        advLink: "#",
        advWidth: 980,
        advType: "7",
        advHeight: 400
